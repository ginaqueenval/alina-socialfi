...
const Fc26Hub = lazy(() => import("./pages/Fc26Hub.jsx"));
const Fc26Players = lazy(() => import("./pages/Fc26Players.jsx"));
const Fc26Sbc = lazy(() => import("./pages/Fc26Sbc.jsx"));
const Fc26Packs = lazy(() => import("./pages/Fc26Packs.jsx"));
    ...
    <div className="min-h-screen w-full max-w-[100vw] overflow-x-hidden bg-[#070A0F] text-[#E7EDF7]">
      ...
      >
        <Routes>
          ...
          <Route path="/fc26" element={<Fc26Hub />} />
          <Route path="/fc26/coins" element={<Fc26 />} />
          <Route path="/fc26/players" element={<Fc26Players />} />
          <Route path="/fc26/sbc" element={<Fc26Sbc />} />
          <Route path="/fc26/packs" element={<Fc26Packs />} />
          <Route
            path="/fc26-coins"
            element={<Navigate to="/fc26/coins" replace />}
          />
